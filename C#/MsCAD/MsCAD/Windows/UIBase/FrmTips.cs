            ...
            else
            {
                ...
                switch (state)
                {
                    case TipsState.Default:
                        frmTips.pctStat.Image = global::MsCAD.Properties.Resources.info;
                        break;
                    case TipsState.Success:
                        frmTips.pctStat.Image = global::MsCAD.Properties.Resources.success;
                        break;
                    case TipsState.Info:
                        frmTips.pctStat.Image = global::MsCAD.Properties.Resources.info;
                        break;
                    case TipsState.Warning:
                        frmTips.pctStat.Image = global::MsCAD.Properties.Resources.warning;
                        break;
                    case TipsState.Error:
                        frmTips.pctStat.Image = global::MsCAD.Properties.Resources.error;
                        break;
                    default:
                        frmTips.pctStat.Image = global::MsCAD.Properties.Resources.info;
                        break;
