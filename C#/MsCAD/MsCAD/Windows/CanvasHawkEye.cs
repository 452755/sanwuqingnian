...
{
    internal partial class CanvasHawkEye : UserControl, ICanvas, MsCAD.DatabaseServices.IDatabaseObserver
    {
        private IPresenter _presenter = null;
        internal delegate void ChangedHawk();
        internal event ChangedHawk changedHawk;

        public CanvasHawkEye()
        {
            InitializeComponent();
