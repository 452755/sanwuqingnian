...
namespace MsCAD.Commands.Draw
{
    internal class RectangleCmd : DrawCmd
    {
        ...
        // 起点+终点
        private Vector2 _point1st = new Vector2(0, 0);
        private Vector2 _point2nd = new Vector2(0, 0);
        ...
        private void UpdateRectangle()
        {
            if (_rectangle == null)
            {
                ...
                for (int i = 0; i < 4; ++i)
                {
                    _rectangle.AddVertexAt(0, new Vector2(0, 0));
                }
            }

            _rectangle.SetPointAt(0, _point1st);
            _rectangle.SetPointAt(1, new Vector2(_point2nd.x, _point1st.y));
            _rectangle.SetPointAt(2, _point2nd);
            _rectangle.SetPointAt(3, new Vector2(_point1st.x, _point2nd.y));
