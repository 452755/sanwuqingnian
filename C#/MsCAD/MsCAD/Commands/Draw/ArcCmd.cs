...
namespace MsCAD.Commands.Draw
{
    ...
    internal class ArcCmd : DrawCmd
    {
        ...
        public override void Initialize()
        {
            ...
            MainWin.Instance.ShowMsg(TipsState.Info, "请点选圆弧圆心");
        }
            ...
            switch (_step)
            {
                case Step.Step1_SpecifyCenter:
                    if (e.Button == MouseButtons.Left)
                    {
                        ...
                        MainWin.Instance.ShowMsg(TipsState.Info, "请点选圆弧起点");
                    }
                    break;
                ...
                case Step.Step2_SpecityStartPoint:
                    if (e.Button == MouseButtons.Left)
                    {
                        ...
                        double startAngle = Vector2.SignedAngleInRadian(
                            new Vector2(1, 0),
                        ...
                        MainWin.Instance.ShowMsg(TipsState.Info, "请点选圆弧终点");
                    }
                    break;
                ...
                case Step.Step3_SpecifyEndPoint:
                    if (e.Button == MouseButtons.Left)
                    {
                        double endAngle = Vector2.SignedAngleInRadian(
                            new Vector2(1, 0),
                            this.pointer.currentSnapPoint - _arc.center);
