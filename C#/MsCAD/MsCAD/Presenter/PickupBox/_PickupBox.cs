...
namespace MsCAD.UI
{
    ...
    internal class PickupBox
    {
        ...
        public void UpdateReservedBounding()
        {
            Vector2 centerInModel = _presenter.CanvasToModel(_center);
        ...
        internal PickupBox(Presenter presenter)
        {
            ...
            RegisterEntityHitter(typeof(MsCAD.DatabaseServices.Rectangle2), new Rectangle2Hitter());
            RegisterEntityHitter(typeof(Solid), new SolidHitter());//新增箭头线
        }
