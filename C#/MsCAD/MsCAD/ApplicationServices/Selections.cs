...
namespace MsCAD.ApplicationServices
{
    public class Selections : IEnumerable<Selection>
    {
        ...
        {
            return this.Add(new Selection(objectId, new Vector2(0, 0)));
        }
        ...
        {
            return this.Remove(new Selection(objectId, new Vector2(0, 0)));
        }

        public void Clear(int num = 0)
        {
        ...
        /// 刷新图元的区域状态
        /// </summary>
        public void RefreshRegionState(Document document)
        {
