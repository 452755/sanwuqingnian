...
namespace MsCAD.DatabaseServices.Filer
{
    ...
    internal class XmlFilerImpl : XmlFiler
    {
        ...
        public override bool Write(string name, MsCAD.Colors.Color value)
        {
            return _Write(name, value);
        }
        ...
        public override bool Write(string name, MsCAD.DatabaseServices.LineWeight value)
        {
            return _Write(name, value);
        }
        ...
        public override bool Read(string name, out MsCAD.Colors.Color value)
        {
            XmlNode node = _curXmlNode.SelectSingleNode(name);
            if (node == null)
            {
                value = MsCAD.Colors.Color.ByLayer;
                return false;
            }

            return MsCAD.Colors.Color.TryParse(node.InnerText, out value);
        }
        ...
        public override bool Read(string name, out MsCAD.DatabaseServices.LineWeight value)
        {
            XmlNode node = _curXmlNode.SelectSingleNode(name);
            if (node == null)
            {
            ...
            value = (LineWeight)Enum.Parse(
                typeof(MsCAD.DatabaseServices.LineWeight), node.InnerText, true);
            return true;
        }
    }
}
