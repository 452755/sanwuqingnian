...
namespace MsCAD.DatabaseServices
{
    public class ArcRec : Entity
    {
        ...
        public ArcRec(Vector2 center, double radius, double startAngle, double endAngle)
        {
            _center = center;
            _radius = radius;
        ...
        {
            ArcRec arcRec = base.Clone() as ArcRec;
            arcRec._center = _center;
            arcRec._radius = _radius;
            arcRec._startAngle = _startAngle;
            arcRec._endAngle = _endAngle;
