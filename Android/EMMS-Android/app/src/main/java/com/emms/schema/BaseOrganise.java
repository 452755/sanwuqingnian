...
public class BaseOrganise extends Model<BaseOrganise, Long> implements Identity<Long> {
    ...
    public static final String ORGANISENAME_equipment = "TeamName";
    public static final String ORGANISE_ID_equipment = "Team_ID";
    public static final String ORGANISENAME_equipment_cross = "FromFactory";
    public static final String PeopleInfor_equipment = "Name";
    public static final String PeopleInfor_Id_equipment = "OperatorID";
