...
public class PushSetActivity extends InstrumentedActivity implements OnClickListener {
	...
	private void setTag(){
		...
		if (TextUtils.isEmpty(tag)) {
			Toast.makeText(PushSetActivity.this, LocaleUtils.getI18nValue("error_tag_empty"), Toast.LENGTH_SHORT).show();
			return;
		}
		...
		for (String sTagItme : sArray) {
			if (!ExampleUtil.isValidTagAndAlias(sTagItme)) {
				Toast.makeText(PushSetActivity.this,LocaleUtils.getI18nValue("error_tag_gs_empty"), Toast.LENGTH_SHORT).show();
				return;
			}
			tagSet.add(sTagItme);
		}
	...
	private void setAlias(){
		...
		if (TextUtils.isEmpty(alias)) {
			Toast.makeText(PushSetActivity.this,LocaleUtils.getI18nValue("error_alias_empty"), Toast.LENGTH_SHORT).show();
			return;
		}
