...
//        CrashReport.initCrashReport(getApplicationContext(), "900057191", true);
        CrashReport.initCrashReport(getApplicationContext(), "36cb539e71", true);
        //地址设置
...
//        String timeZone = SharedPreferenceManager.getTimeZone(this);
//        LogUtils.e("从系统中获取到timezone---->"+timeZone);
//        AppTimeZone = "GMT"+7;
    ...
    public static String getTimeZone(){
        String timeZone = SharedPreferenceManager.getTimeZone(context);
        LogUtils.e("从系统中获取到timezone---->"+timeZone);
        return "GMT+"+timeZone;
    }
