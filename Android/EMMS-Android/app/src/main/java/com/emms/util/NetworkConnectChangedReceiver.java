...
public class NetworkConnectChangedReceiver extends  BroadcastReceiver{
    ...
    public static void initNetWorkData(){
        ...
        mNetworkList.add("esq-apps-ymkeyi");
        mNetworkList.add("esq-apps-gegkeyi");
        mNetworkList.add("esq-apps-wh");
//        mNetworkList.add("APJ-EEL");
    }
                ...
                if (NetworkInfo.State.CONNECTED == info.getState() && info.isAvailable()) {
                    if (info.getType() == ConnectivityManager.TYPE_WIFI
                        ...
                        if(info.getType()==ConnectivityManager.TYPE_WIFI){
                            ...
                            ToastUtil.showToastLong(LocaleUtils.i18nLength() > 0 ? LocaleUtils.getI18nValue("CheckForMONET") : context.getString(R.string.CheckForMONET),context);
