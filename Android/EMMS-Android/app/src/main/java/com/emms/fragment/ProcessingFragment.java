       ...
       listView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
        ...
        taskAdapter = new TaskAdapter(datas) {
            ...
            public View getCustomView(View convertView, int position, ViewGroup parent) {
                ...
                if(TaskClass.contains(Task.Lend_TASK)){
                    ((TextView)convertView.findViewById(R.id.Warranty_person_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.Warranty_person)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.target_group_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.target_group)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.id_start_time_description)).setVisibility(View.VISIBLE);
                    ((TextView)convertView.findViewById(R.id.tv_start_time_process)).setVisibility(View.VISIBLE);

                    ((TextView)convertView.findViewById(R.id.id_task_description)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.tv_task_describe)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.id_end_time_description)).setVisibility(View.VISIBLE);
                    ((TextView)convertView.findViewById(R.id.tv_end_time_process)).setVisibility(View.VISIBLE);
                    ...
                    ((TextView)convertView.findViewById(R.id.dynomicp1_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.dynomicp1_description)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.dynomicp2_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.dynomicp2_description)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.dynomicp3_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.dynomicp3_description)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.dynomicp4_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.dynomicp4_description)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.dynomicp5_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.dynomicp5_description)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.Task_Equipment_Num_tag)).setVisibility(View.GONE);
                    ((TextView)convertView.findViewById(R.id.Task_Equipment_Num)).setVisibility(View.GONE);

                    ((TextView)convertView.findViewById(R.id.Task_Equipment_tag)).setVisibility(View.VISIBLE);
                    ((TextView)convertView.findViewById(R.id.Task_Equipment)).setVisibility(View.VISIBLE);

                    ((TextView)convertView.findViewById(R.id.id_group)).setText("任务单号:");
                    holder.tv_group.setText(DataUtil.isDataElementNull(datas.get(position).get(Task.TASK_ID)));

                    ((TextView)convertView.findViewById(R.id.id_start_time_description)).setText("Move From:");
                    holder.tv_move_from=(TextView)convertView.findViewById(R.id.tv_start_time_process);
                    holder.tv_move_from.setText(DataUtil.isDataElementNull(datas.get(position).get(Task.Move_From)));

                    ((TextView)convertView.findViewById(R.id.id_end_time_description)).setText("Move To:");
                    holder.tv_move_to=(TextView)convertView.findViewById(R.id.tv_end_time_process);
                    holder.tv_move_to.setText(DataUtil.isDataElementNull(datas.get(position).get(Task.Move_TO)));

                    ((TextView)convertView.findViewById(R.id.Task_Equipment_tag)).setText("任务备注:");
                    holder.Task_Descr=(TextView)convertView.findViewById(R.id.Task_Equipment);
                    holder.Task_Descr.setText(DataUtil.isDataElementNull(datas.get(position).get("TaskDescr")));
...
//        params.put("pageIndex",pageIndex);
        ...
        data.set("status",1);
        if(TaskClass.contains("T09")){
            data.set("taskClass",Task.Equipment_Borrow_Return);;
        }else {
        ...
        LogUtils.e("提交的数据格式--->"+data.toString());
