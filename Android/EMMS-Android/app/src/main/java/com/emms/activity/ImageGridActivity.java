...
public class ImageGridActivity extends Activity
{
	...
	Handler mHandler = new Handler()
	{
		...
		public void handleMessage(Message msg)
		{
			...
			{
			case 0:
				Toast.makeText(ImageGridActivity.this, LocaleUtils.getI18nValue("max_picture"), Toast.LENGTH_SHORT).show();
				break;
	...
	private void initView()
	{
		...
		((TextView) findViewById(R.id.tv_title)).setText(LocaleUtils.getI18nValue("album"));
		...
		adapter.setTextCallback(new ImageGridAdapter.TextCallback()
		{
			...
			{
				bt.setText(LocaleUtils.getI18nValue("finish") + "(" + count + ")");
			}
		});
