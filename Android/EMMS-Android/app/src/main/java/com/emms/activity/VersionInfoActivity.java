...
public class VersionInfoActivity extends NfcActivity implements View.OnClickListener {
    ...
    private void initView() {
        ((TextView) findViewById(R.id.tv_title)).setText(LocaleUtils.getI18nValue("version_info"));
        ((TextView) findViewById(R.id.connect_email_tag)).setText(LocaleUtils.getI18nValue("connect_email"));
        ...
        String email = "SoAn@esquel.com(Andrew So)";
