...
public class StyleChangeCheckInActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
//            handler = new CaptureActivityHandler(CaptureActivity.class, decodeFormats, characterSet);
        }
    }
    ...
    protected void showResult(final Result rawResult, Bitmap barcode) {
        inactivityTimer.onActivity();
        Intent it = new Intent(this, CusActivity.class);
